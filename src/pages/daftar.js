    ...
    return (
        ...
        <Head><title>Minejobs - Daftar</title></Head>
          ...
          <div className="w-full sm:w-1/3">
              <Link href="/"><a><img className="ml-10 mr-3 w-5 h-5 inline"src="http://localhost:3000/images/left-arrow.svg"/>
                  <p className="hidden sm:inline text-sm text-gray-800 ">Kembali</p></a>
                </Link>
              </div>
              <div className="w-full sm:w-1/3">
            <div className="sm:mt-20 mt-5 border border-gray-300">
                ...
                <button className="mx-3 sm:mx-20 bg-white border border-gray-500 shadow rounded mb-5 p-2 px-8 text-gray-700 hover:bg-gray-200 text-sm">
                    <img  className="w-4 h-4 inline mr-2"src="http://localhost:3000/images/google-icon.png"/>
